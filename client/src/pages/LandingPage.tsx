...
export function LandingPage() {
  ...
  const { setCurrentUser } = useDemoUser();
      ...
      <section className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl items-center gap-8 lg:grid-cols-[1.08fr_0.92fr]">
        ...
        <div className="rounded-lg border border-black/10 bg-white p-6 shadow-panel">
          ...
          <p className="mt-2 text-sm leading-6 text-ink/65">
            Skip login friction and inspect the CRM from different stakeholder perspectives.
          </p>

          <label className="mt-6 block text-sm font-semibold" htmlFor="demo-role">
            Demo persona
          </label>
          <select
            id="demo-role"
